...
menuItems.forEach((item, index) => {
  item.addEventListener("click", () => {
    ...
    //assing new colors
    currentProductColors.forEach((colorEI, i) =>
       {
        if (choosenProduct.colors[i]){
          colorEI.style.backgroundColor=choosenProduct.colors[i].code;
          colorEI.style.display="none";//
//sembunyikan jika tiada warna kedua
        }
      });
    });
});

//Tukarkan imej ikut warna
...
const sliderButton = document.querySelectorAll(".buyButton");
